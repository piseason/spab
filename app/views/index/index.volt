...
<div class="control">
	...
	<button class='btn btn-warning'  onmouseover= "this.style.backgroundColor = 'rgba(229,100,25,0.5)' ;this.style.color='#FFF' ;" onmouseout  ="this.style.backgroundColor = 'rgba(229,100,25,0.7)' ;this.style.color='#000' " onclick="window.location='/superadmi/index'">管理员入口</button>
</div>
